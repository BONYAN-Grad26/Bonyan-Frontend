...
export default function GymClassifierPage() {
  ...
  return (
    <main  className="min-h-screen bg-slate-50 text-slate-800 flex flex-col items-center justify-center p-4 antialiased">
      <div data-aos="fade-down" className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-100 p-6 transition-all duration-300">
        ...
        {!result ? (
          <div className="space-y-4">
            ...
            >
              ...
              {previewUrl ? (
                ...
                <>
                  <svg className={`w-12 h-12 mb-3 text-slate-400 ${isDragging ? "text-sky-500 scale-110" : ""} transition-transform`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <div className="text-sm text-slate-600">
                    <span className="font-semibold text-sky-600">Click to upload machine photo</span> or drag it here
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-xl text-white font-medium shadow-md transition-all duration-150 flex items-center justify-center space-x-2 ${
                !file || isAnalyzing
                  ...
                  : "bg-sky-600 hover:bg-sky-700 active:scale-[0.98] shadow-sky-600/10"
              }`}
            >
              {isAnalyzing ? (
                <>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-sky-50 border border-sky-100 rounded-xl p-4 text-center">
              <span className="text-xs uppercase tracking-wider font-bold text-sky-700 block">Machine Identified</span>
